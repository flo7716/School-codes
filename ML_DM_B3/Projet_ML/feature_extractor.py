...
image = cv2.imread('/home/florian-andr/Downloads/dataset/b/IMG_23511112.png', cv2.IMREAD_GRAYSCALE)
...
# Créer une copie de l'image pour afficher les régressions
...
# Afficher l'image avec les régressions
plt.imshow(image_with_regressions)
plt.title("Régressions linéaires sur la lettre")
