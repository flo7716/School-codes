...
def add_entity(entity: str, data: Dict[str, Any]):
...
def get_all_entities(entity: str) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        # Retrieve column names to return data as a list of dictionaries
...
def get_entity_by_id(entity: str, entity_id: int, id_column: str = "ID"):
    connection, cursor = connect_database()
    try:
...
def update_entity(entity: str, entity_id: int, data: Dict[str, Any], id_column: str = "ID"):
    connection, cursor = connect_database()
    try:
        # Dynamically generate the SQL query
...
def delete_entity(entity: str, entity_id: int, id_column: str = "ID"):
    connection, cursor = connect_database()
    try:
