...
# Vagrant + KVM/QEMU setup for a Linux Kubernetes cluster
# This script sets up a basic Kubernetes cluster using Vagrant and KVM/QEMU.    
...
# Install Vagrant and KVM/QEMU
$UPDATE_CMD
$INSTALL_CMD vagrant qemu-kvm libvirt-daemon-system libvirt-clients bridge-utils
